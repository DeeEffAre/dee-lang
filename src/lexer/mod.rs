    ...
    pub fn next_token(&mut self) -> Token {
        ...
        match self.current_char {
            ...
            b'_' => {
                self.read_char();
                Token {
                    kind: TokenType::TokenUnderscore,
                    span: Span::new(start, self.position),
                }
            }
            b'a'..=b'z' | b'A'..=b'Z' => self.read_identifier_or_keyword(),
...
mod test {
    ...
    fn tokenize_a_program() {
        ...
        let expected_token_kinds = [
            ...
            TokenType::TokenOpenParen,
            TokenType::TokenStringConstant(Symbol(12)),
            TokenType::TokenCloseParen,
            TokenType::TokenComma,
            TokenType::TokenCloseBrace,
            TokenType::TokenIdentifier(Symbol(13)),
            TokenType::TokenIdentifier(Symbol(14)),
            TokenType::TokenAssign,
            TokenType::TokenIdentifier(Symbol(7)),
            TokenType::TokenDot,
            ...
            TokenType::TokenOpenParen,
            TokenType::TokenStringConstant(Symbol(19)),
            TokenType::TokenComma,
            TokenType::TokenStringConstant(Symbol(20)),
            TokenType::TokenCloseParen,
            TokenType::TokenCloseParen,
            TokenType::TokenCloseBrace,
            TokenType::TokenStatic,
            ...
            TokenType::TokenSelf,
            TokenType::TokenDot,
            TokenType::TokenIdentifier(Symbol(21)),
            TokenType::TokenPlus,
            TokenType::TokenIntConstant(1),
            TokenType::TokenLessEqual,
            TokenType::TokenSelf,
            TokenType::TokenDot,
            TokenType::TokenIdentifier(Symbol(22)),
            TokenType::TokenCloseParen,
            TokenType::TokenOpenBrace,
            TokenType::TokenSelf,
            TokenType::TokenDot,
